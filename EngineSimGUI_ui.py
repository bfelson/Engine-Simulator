...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_33.setSpacing(25)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filebrowsebutton.setText(QCoreApplication.translate("MainWindow", u"Browse for File", None))
        ...
        self.turbooutlettemplabel.setText(QCoreApplication.translate("MainWindow", u"Outlet Temperature(K)", None))
        self.turbooutletpressurelabel.setText(QCoreApplication.translate("MainWindow", u"Outlet Pressure (Pa)", None))
